...
class SuppliesControllerTest < ActionController::TestCase
  ...
  test "should create supply" do
    assert_difference('Supply.count') do
      post :create, supply: { budget_id: @supply.budget_id, cost: @supply.cost, quantity: @supply.quantity, supplier_id: @supply.supplier_id, type: @supply.type }
    end
  ...
  test "should update supply" do
    patch :update, id: @supply, supply: { budget_id: @supply.budget_id, cost: @supply.cost, quantity: @supply.quantity, supplier_id: @supply.supplier_id, type: @supply.type }
    assert_redirected_to supply_path(assigns(:supply))
  end
